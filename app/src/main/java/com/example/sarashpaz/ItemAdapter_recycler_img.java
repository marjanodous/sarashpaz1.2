...
//        holder.aAvatar3.setImageResource(aItemRecyclerimg.getuAvatar3());
        ...
        holder.aAvatar3.setImageResource(item3ListRecyclerimg.get(position).getuAvatar3());
        holder.aAvatar3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.i("bundle:)))))))", String.valueOf(item3ListRecyclerimg.get(position).getuAvatar3()));

//                flag_img = true;
                Frg_img frg_img = new Frg_img();
//                frg_img = Frg_img.newInstance(item3ListRecyclerimg.get(position).getuAvatar3());
                AppCompatActivity activity = (AppCompatActivity) view.getContext();
                Fragment myFragment = new Frg_img();
                myFragment = frg_img.newInstance(item3ListRecyclerimg.get(position).getuAvatar3());
